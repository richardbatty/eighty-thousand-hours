...
$(document).ready(function() {
  ...
  initialise_slider("#user_eighty_thousand_hours_application_attributes_hic_activity_hours", "min", 0, 168, 5, 5);
  initialise_slider("#user_eighty_thousand_hours_application_attributes_average_income", "min", 10000, 5000000, 10000, 100000, function(x){ return x.formatMoney(0,'.',','); } );
});
